...
def task(doc_name, from_doctype, to_doctype):
	from beasm.accounts.doctype.payment_entry import payment_entry
	from beasm.accounts.doctype.purchase_invoice import purchase_invoice
	from beasm.accounts.doctype.sales_invoice import sales_invoice
	from beasm.buying.doctype.purchase_order import purchase_order
	from beasm.buying.doctype.supplier_quotation import supplier_quotation
	from beasm.selling.doctype.quotation import quotation
	from beasm.selling.doctype.sales_order import sales_order
	from beasm.stock.doctype.delivery_note import delivery_note
	from beasm.stock.doctype.purchase_receipt import purchase_receipt
