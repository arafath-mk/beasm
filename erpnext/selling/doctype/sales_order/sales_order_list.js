frappe.listview_settings['Sales Order'] = {
	...
	onload: function(listview) {
		var method = "beasm.selling.doctype.sales_order.sales_order.close_or_unclose_sales_orders";
		...
		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			beasm.bulk_transaction_processing.create(listview, "Sales Order", "Sales Invoice");
		});

		listview.page.add_action_item(__("Delivery Note"), ()=>{
			beasm.bulk_transaction_processing.create(listview, "Sales Order", "Delivery Note");
		});

		listview.page.add_action_item(__("Advance Payment"), ()=>{
			beasm.bulk_transaction_processing.create(listview, "Sales Order", "Payment Entry");
		});
