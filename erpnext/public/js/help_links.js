...
const docsUrl = "https://beasm.com/docs/";

frappe.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-beasm/articles/bulk-rename",
	},
];
...
frappe.help.help_links["Form/PayPal Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/beasm_integration/paypal-integration",
	},
];
...
frappe.help.help_links["Form/Razorpay Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/beasm_integration/razorpay-integration",
	},
];
...
frappe.help.help_links["Form/Dropbox Settings"] = [
	{
		...
		url: docsUrl + "user/manual/en/beasm_integration/dropbox-backup",
	},
];
...
frappe.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
		url:
			docsUrl + "user/manual/en/beasm_integration/ldap-integration",
	},
];
...
frappe.help.help_links["Form/Stripe Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/beasm_integration/stripe-integration",
	},
];
...
frappe.help.help_links["List/Authorization Rule"] = [
	{
		...
		url: docsUrl + "user/manual/en/customize-beasm/authorization-rule",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-beasm/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-beasm/customize-form",
	},
];
