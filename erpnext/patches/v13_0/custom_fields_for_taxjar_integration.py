...
from beasm.beasm_integrations.doctype.taxjar_settings.taxjar_settings import add_permissions
...
def execute():
	...
	add_permissions()
	frappe.enqueue(
		"beasm.beasm_integrations.doctype.taxjar_settings.taxjar_settings.add_product_tax_categories",
		now=True,
	)
