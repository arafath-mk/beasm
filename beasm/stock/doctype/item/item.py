			...
			for item_barcode in self.barcodes:
				...
				if item_barcode.barcode:
					...
					if item_barcode.barcode_type:
						barcode_type = convert_beasm_to_barcodenumber(
...
def convert_beasm_to_barcodenumber(beasm_number, barcode):
	if beasm_number == "EAN":
		ean_type = {
			8: "EAN8",
			13: "EAN13",
	...
	if beasm_number in convert:
		return convert[beasm_number]
