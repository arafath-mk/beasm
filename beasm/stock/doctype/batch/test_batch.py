...
from beasm.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
...
from beasm.stock.serial_batch_bundle import SerialBatchCreation
...
class TestBatch(FrappeTestCase):
	...
	def test_batch_split(self):
		...
		from beasm.stock.doctype.batch.batch import split_batch
