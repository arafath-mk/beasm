...
beasm.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
beasm.stock.LandedCostVoucher = class LandedCostVoucher extends beasm.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(beasm.stock.LandedCostVoucher);
