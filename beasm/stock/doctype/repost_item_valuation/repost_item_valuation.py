...
import beasm
from beasm.accounts.general_ledger import validate_accounting_period
from beasm.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
...
def repost_gl_entries(doc):
	if not cint(beasm.is_perpetual_inventory_enabled(doc.company)):
		return
