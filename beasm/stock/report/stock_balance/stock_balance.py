...
import beasm
from beasm.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from beasm.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from beasm.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from beasm.stock.utils import add_additional_uom_columns
...
class StockBalanceReport(object):
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = beasm.get_company_currency(self.filters.get("company"))
		else:
