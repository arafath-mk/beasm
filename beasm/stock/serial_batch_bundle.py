...
from beasm.stock.deprecated_serial_batch import (
	DeprecatedBatchNoValuation,
	DeprecatedSerialNoValuation,
)
from beasm.stock.valuation import round_off_if_near_zero
...
class SerialBatchBundle:
	...
	def update_batch_qty(self):
		from beasm.stock.doctype.batch.batch import get_available_batches
...
class SerialBatchCreation:
	...
	def set_auto_serial_batch_entries_for_outward(self):
		from beasm.stock.doctype.batch.batch import get_available_batches
		from beasm.stock.doctype.serial_no.serial_no import get_serial_nos_for_outward
