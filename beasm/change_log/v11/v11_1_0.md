- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any BEASM user can list their products and be discovered by thousands of other companies using BEASM
...
- Changes have been made to ensure BEASM is compatible with Python 3
