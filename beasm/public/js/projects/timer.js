frappe.provide("beasm.timesheet");

beasm.timesheet.timer = function(frm, row, timestamp=0) {
	...
	beasm.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

beasm.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
