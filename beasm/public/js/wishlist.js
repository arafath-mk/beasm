frappe.provide("beasm.e_commerce.wishlist");
var wishlist = beasm.e_commerce.wishlist;

frappe.provide("beasm.e_commerce.shopping_cart");
var shopping_cart = beasm.e_commerce.shopping_cart;
...
$.extend(wishlist, {
	...
	wishlist_action(btn) {
		...
		let success_action = function() {
			beasm.e_commerce.wishlist.set_wishlist_count(true);
		};
	...
	add_remove_from_wishlist(action, args, success_action, failure_action, async=false) {
		...
		if (frappe.session.user==="Guest") {
			...
			let method = "beasm.e_commerce.doctype.wishlist.wishlist.add_to_wishlist";
			if (action === "remove") {
				method = "beasm.e_commerce.doctype.wishlist.wishlist.remove_from_wishlist";
			}
	...
	redirect_guest() {
		frappe.call('beasm.e_commerce.api.get_guest_redirect_on_action').then((res) => {
		...
		$(".page_content").append(`
			<div class="cart-empty frappe-card">
				<div class="cart-empty-state">
					<img src="/assets/beasm/images/ui-states/cart-empty-state.png" alt="Empty Cart">
				</div>
