...
from beasm.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "beasm")
	try:
		...
		capture("demo_data_creation_failed", "beasm", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "beasm")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "beasm")
	try:
