...
beasm.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new beasm.support.WarrantyClaim({frm: cur_frm}));
