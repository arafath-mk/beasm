...
frappe.require("assets/beasm/js/financial_statements.js", function() {
	frappe.query_reports["Trial Balance"] = {
		"filters": [
			...
			},
			{
				...
				"label": __("From Date"),
				"fieldtype": "Date",
				"default": beasm.utils.get_fiscal_year(frappe.datetime.get_today(), true)[1],
			},
			{
				"fieldname": "to_date",
				"label": __("To Date"),
				"fieldtype": "Date",
				"default": beasm.utils.get_fiscal_year(frappe.datetime.get_today(), true)[2],
			},
			{
	...
	beasm.utils.add_dimensions('Trial Balance', 6);
});
