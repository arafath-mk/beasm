...
beasm.accounts.pos.setup("POS Invoice");
beasm.selling.POSInvoiceController = class POSInvoiceController extends beasm.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new beasm.selling.POSInvoiceController({ frm: cur_frm }))
