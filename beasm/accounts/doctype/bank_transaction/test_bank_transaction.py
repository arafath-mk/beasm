...
from beasm.tests.utils import if_lending_app_installed
...
class TestBankTransaction(FrappeTestCase):
	...
	# This test checks if BEASM is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if BEASM can correctly filter a linked payments based on the debit/credit amount
