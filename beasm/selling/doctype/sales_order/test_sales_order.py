...
from beasm.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from beasm.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_drop_shipping(self):
		from beasm.buying.doctype.purchase_order.purchase_order import update_status
		from beasm.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from beasm.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from beasm.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from beasm.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from beasm.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from beasm.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_stock_reservation_against_sales_order(self) -> None:
		...
		from beasm.stock.doctype.stock_reservation_entry.stock_reservation_entry import (
			cancel_stock_reservation_entries,
			get_sre_reserved_qty_details_for_voucher,
			get_stock_reservation_entries_for_voucher,
			has_reserved_stock,
		)
		from beasm.stock.doctype.stock_reservation_entry.test_stock_reservation_entry import (
			create_items,
